...
const Hero = () => {
  ...
  return (
    <section
      id="inicio"
      className="relative isolate min-h-[99vh] scroll-mt-28 overflow-hidden sm:scroll-mt-24"
    >
      <div className="mx-auto flex w-full max-w-7xl px-4 pb-10 pt-24 sm:pb-14 sm:pt-28 lg:pt-30 animate-enter">
        <div className="max-w-2xl sm:ml-0 lg:ml-8">
          <p className="mb-4 inline-flex rounded-full border border-white/20 bg-white/5 px-3 py-2 text-[10px] font-bold uppercase tracking-wide text-white/95 sm:mb-5 sm:px-4 sm:text-xs animate-enter animate-delay-1">
          ...
          <p className="mt-4 max-w-xl text-[0.95rem] text-white/90 sm:mt-5 sm:text-base animate-enter animate-delay-3">
